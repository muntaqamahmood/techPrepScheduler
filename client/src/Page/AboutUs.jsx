  ...
  return (
    <div className="Aboutus">
      ...
      <div className="aboutus-element">
        ...
        for technical interviews. Users can schedule mock interviews with other
        users and conduct mock interviews in real-time using our platform's live
        code editor and compiler, as well as its chat and voice chat features.
        Users can select to either be the interviewer or the interviewee when
        using TechPrep Scheduler. Users can ask questions, provide feedback,
        write and review code all through our platform's code editor, chat and
        voice chat features.
      </div>
